...
| `GITHUB_CLIENT_ID`          | GitHub OAuth client id. Together with the secret, makes the GitHub sign-in button and its connected accounts row appear.                                                 | unset by default (provider hidden). See the authentication feature page.                                                                                                                                                                                                |
| `GITHUB_CLIENT_SECRET`      | GitHub OAuth client secret.                                                                                                                                              | unset by default                                                                                                                                                                                                                                                        |
| `GOOGLE_CLIENT_ID`          | Google OAuth client id. Together with the secret, makes the Google sign-in button and its connected accounts row appear.                                                 | unset by default (provider hidden). See the authentication feature page.                                                                                                                                                                                                |
| `GOOGLE_CLIENT_SECRET`      | Google OAuth client secret.                                                                                                                                              | unset by default                                                                                                                                                                                                                                                        |
