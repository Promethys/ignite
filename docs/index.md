...
features:
  ...
  - title: Self-Hosting
    details: Ignite is source-available (FSL-1.1-MIT) and self-hostable. Run it on your own infrastructure with Laravel, Vue, Inertia, and PostgreSQL.
  - title: Feature Docs
    details: Learn how each goal type works, how progress is calculated, and how to configure Ignite for your own deployment.
---
