...
return [
    ...
    'password' => [
        ...
        'create_title' => 'Créer un mot de passe',
        'create_description' => 'Vous vous connectez avec un compte lié. Ajoutez un mot de passe pour pouvoir aussi vous connecter avec votre adresse e-mail.',
    ...
    'api_tokens' => [
        ...
        'description' => 'Générez des jetons pour authentifier des clients externes tels que le serveur MCP.',
        'name' => 'Nom du jeton',
        'name_placeholder' => 'ex. Claude Desktop',
        'abilities' => 'Permissions',
        'ability_read' => 'Lecture (voir les objectifs, entrées, jalons)',
        'ability_write' => 'Écriture (enregistrer la progression, créer et modifier des objectifs)',
        'ability_delete' => 'Suppression (supprimer des objectifs et des entrées)',
        'ability_short' => [
            'read' => 'Lecture',
            'write' => 'Écriture',
            'delete' => 'Suppression',
        ],
        'create' => 'Générer le jeton',
        'creating' => 'Génération...',
        'your_tokens' => 'Vos jetons',
        'empty' => 'Vous n\'avez pas encore créé de jeton.',
        'last_used' => 'Dernière utilisation',
        'never' => 'Jamais',
        'revoke' => 'Révoquer',
        'revoke_title' => 'Révoquer le jeton API',
        'revoke_confirm' => 'Révoquer ce jeton ? Tout client l\'utilisant perdra immédiatement l\'accès.',
        'created_at' => 'Créé le',
        'reveal_title' => 'Jeton créé',
        'reveal_description' => 'Copiez ce jeton maintenant. Pour des raisons de sécurité, il ne sera plus affiché.',
        'copy' => 'Copier',
    ],
];
