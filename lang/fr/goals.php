...
return [
    ...
    'form' => [
        ...
        'points' => 'Points',
        'type_help' => 'Détermine comment la progression est mesurée et comment vous l\'enregistrez. Quantifiable compte vers un nombre, récurrent suit une habitude sous forme de série, multi-étapes est une liste de jalons, et simple est fait ou pas fait. Vous pourrez le changer plus tard.',
        'current_value_help' => 'Votre point de départ. La progression est mesurée à partir de là : un objectif créé à 120 sur 500 km affiche ce que vous ajoutez à partir de maintenant.',
        'recurrence_help' => 'À quelle fréquence l\'habitude se répète. Chaque période compte une fois dans la série, et manquer la période en cours ne la rompt pas tant qu\'elle n\'est pas terminée.',
        'direction' => 'Sens',
