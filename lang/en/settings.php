...
return [
    ...
    'api_tokens' => [
        ...
        'description' => 'Generate tokens to authenticate external clients such as the MCP server.',
        'name' => 'Token name',
        'name_placeholder' => 'e.g. Claude Desktop',
        'abilities' => 'Abilities',
        'ability_read' => 'Read (view goals, entries, milestones)',
        'ability_write' => 'Write (log progress, create and edit goals)',
        'ability_delete' => 'Delete (remove goals and entries)',
        'ability_short' => [
            'read' => 'Read',
            'write' => 'Write',
            'delete' => 'Delete',
        ...
        'revoke_confirm' => 'Revoke this token? Any client using it will immediately lose access.',
        'created_at' => 'Created',
        'reveal_title' => 'Token created',
        'reveal_description' => 'Copy this token now. For security, it will not be shown again.',
        'copy' => 'Copy',
    ],
];
